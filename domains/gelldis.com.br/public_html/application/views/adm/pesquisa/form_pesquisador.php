...
?>
<form method="post" action="{url}gerenciar/pesquisador/adicionando" >
    ...
    <div class="form-group">
        ...
        <input type="text" name="titulacao" id="titulacao" class="form-control" required="true"/>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="text" name="espelho_membro_link" id="espelho_membro_link" class="form-control"/>
    </div>
    <div class="form-group">
