...
<script>
    ...
    function confirmar(url) {
        ...
        cancelar();
        window.location.href = aUrl + 'gerenciar/reuniaopr/excluir/' + id_reuniao;
    }
</script>
...
<table id="tabela" class="table table-bordered">
    ...
    <tbody>
        ...
        <tr>
            <td> {titulo} </td>
            <td> <a class="btn btn-primary" href="{url}gerenciar/reuniaopr/editar/{id_reuniao}"><i class="fa fa-edit"></i></a>  </td>
...
<div class="col-sm-12" style="margin-top: 2%; margin-bottom: 2%;">
    <a class="btn btn-success" href="{url}gerenciar/reuniaopr/adicionar"> <i class="fa fa-plus-circle"></i> Adicionar</a>
</div>
